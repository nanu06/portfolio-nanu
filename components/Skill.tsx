  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        alt="Skill"
        className="rounded-full border-gray-500 object-cover bg-center bg-no-repeat bg-contain w-20 h-20 xl:w-20 xl:h-20  md:h-15 md:w-15 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
